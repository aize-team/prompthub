        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 md:gap-8">
          ...
          <div className="col-span-1 md:col-span-1">
            <Link href="/" className="flex items-center mb-6 group">
              <div className="w-10 h-10 rounded-lg bg-gradient-to-r from-blue-600 to-purple-600 flex items-center justify-center text-white font-bold mr-3 shadow-md group-hover:shadow-lg transition-all duration-300">
                A
              </div>
